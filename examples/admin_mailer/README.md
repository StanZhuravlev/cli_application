...
* [Добавить подпись письма (footer)](#toc3)
...
Создадим тестовый скрипт - `test_log.rb`, в котором сделаем такую функцию `main`.
...
В папке, где лежит приложение `test_log.rb` появилась папка mail. В ней - файл `test-log-mail-2015-06-10.txt`
...
## <a name="toc3"/>Добавить подпись письма (footer)
